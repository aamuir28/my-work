...
function AddPlantForm({ communityId, plotId }) {
    ...
    //     evt.preventDefault();
    //     save(currentPlant)
    //         .then((currentPlant) => navigate(`/Community/${currentPlant.communityId}/viewplot/${currentPlant.plotId}`))
    //         .catch(errs => {
    //             if (errs) {
    //                 setErrors(errs);
    //             } else {
    ...
    function handleSubmit(evt) {
        ...
        save(currentPlant)
          .then((savedPlant) => {
            ...
            // navigate(`/Community/${communityId}/viewplot/${savedPlant.plotId}`);
            navigate("/Community")
          })
          .catch((err) => {
            console.error(err);
            setErrors(['An error occurred while saving the plant.']);
          });
      }
